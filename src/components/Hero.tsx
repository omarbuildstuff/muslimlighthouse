...
const Hero = () => {
  return (
    <section className="pt-24 pb-16 md:pt-32 md:pb-20 lg:pt-40 lg:pb-32 px-4 md:px-6 bg-gradient-to-b from-lighthouse-50/50 to-white">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-navy-400 text-base sm:text-lg md:text-xl mb-6 md:mb-8 max-w-xl mx-auto md:mx-0">
