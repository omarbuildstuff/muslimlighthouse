...
const FreeLesson = () => {
  ...
  return <section id="free-lesson" className="section-padding bg-white">
          ...
          <div className="flex flex-col gap-12 items-center">
            ...
            <div className="lg:w-1/2 max-w-xl">
              <div className="video-container relative overflow-hidden rounded-3xl shadow-xl border-4 border-white aspect-video">
                {isPlaying ? <iframe src={`https://www.youtube.com/embed/${videoId}?autoplay=1`} title="Free lesson preview" className="absolute top-0 left-0 w-full h-full border-0" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe> : <>
                    ...
                    <img src="https://img.youtube.com/vi/w-w47CSUuIo/maxresdefault.jpg" alt="Free lesson preview" className="w-full h-full object-cover" />
                  </>}
              </div>
            </div>
          </div>
