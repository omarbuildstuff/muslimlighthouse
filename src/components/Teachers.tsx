  ...
  const teachers = [
    {
      ...
      credentials: [
        { icon: GraduationCap, text: "Ijazah in multiple classical texts" },
        { icon: Briefcase, text: "10+ years teaching experience" },
        { icon: Globe, text: "Studied in Mauritania, Egypt and Jordan" },
      ]
    },
    {
      ...
      credentials: [
        { icon: GraduationCap, text: "Traditional ijazahs from senior scholars" },
        { icon: Briefcase, text: "Author of works on Islamic jurisprudence" },
        { icon: Globe, text: "Trained in the Mauritanian tradition" },
      ]
    },
  ];
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {teachers.map((teacher) => (
            <div key={teacher.name} className="glass-card overflow-hidden group">
              ...
              <div className="p-6 md:p-8">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
                  ...
                  <span className="text-lighthouse-500 font-medium">{teacher.role}</span>
                </div>
