...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white py-4 shadow-lg animate-in fade-in slide-in-from-top-5">
          <nav className="container mx-auto flex flex-col items-center gap-4">
            <a 
              href="#program" 
              className="text-navy-500 hover:text-lighthouse-500 transition-colors py-2 w-full text-center font-medium"
